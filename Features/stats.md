...
| [Daily Bonus multiplier](/Systems/daily-bonus.md)                 | `DAILY_MULTIPLIER`            | The current multiplier of the user that will be applied to their bonus.                      | No           | Yes       |
| [Daily Bonus days paused](/Systems/daily-bonus.md)                    | `DAILY_DAYS_PAUSED`           | The amount of days the user has misse                                                        | No           | Yes       |
